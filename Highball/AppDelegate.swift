...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ianynda.Highball" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("Highball", withExtension: "momd")
...
//        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Highball.sqlite")
